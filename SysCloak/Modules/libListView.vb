...
Namespace UIControls
   ...
   Public Module libListView
      ...
      '-----------------------------------------------------------------------------------------------
      ' Add ListView item
      Public Sub LVCB_AddItem(lv As ListView, grp As ListViewGroup, name As String, isChecked As Boolean, Optional hasCheckBox As Boolean = False, Optional CheckBoxIsChecked As Boolean = False, Optional CheckBoxText As String = "Restore default")
         Dim item As New ListViewItem(name)
         item.SubItems.Add("")
         item.Checked = isChecked
